...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
  	<td align="center">Selecciona el nombre de la institucion de la cual provienes, seleccionando si deseas practicas<br> profesionales  o servicio social</td>
  </tr>
  ...
  <tr>
  	<td align=center>
            ...
            <form name="forma" method="post" action="nuevoalumno2.php">
