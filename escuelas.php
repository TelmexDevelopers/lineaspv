...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr valign=top>
  	<td align="right">
		...
		<a href='escuelas_nuevo1.php' style="text-decoration:none">
		      ...
		      <td align="center" width="50">
				...
				<? 	
					...
					{	
						...
						echo "<a href='escuelas_cambios1.php?id_escuela=".$row['id_escuela']."'>";
						...
						echo"<td>";
						echo "<font face='Arial' size=2>&nbsp;";
						echo "<a href='escuelas_baja1.php?id_escuela=".$row['id_escuela']."'>";
                    	echo "ELIMINAR</font>";
						echo "</a></td>";
