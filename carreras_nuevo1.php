...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr valign="middle">
  	<td align=center>
            ...
            <form name="forma" method="post" action="carreras_nuevo2.php">
		                                ...
		                                $result2 = mysql_query($query2);
		                                 $num_results2 = mysql_num_rows($result2);
											...
											{	$row2=mysql_fetch_array($result2);
												echo "<OPTION VALUE=".$row2['id_escuela'].">".$row2['nombre']."</option>";
											}
										?>
									</SELECT></td></b><tr>
			<tr>
            	<td><font face="Arial" size="2" color="#3F92D5"><b>
            		CARRERA</font>      </td>
            	<td><input name="carrera" type="text" style="max-width:100" value="" size="50" maxlength="200"  onkeypress='return alfanumerico(event)' Onblur="this.value = this.value.toUpperCase();"></td>
            </tr>
