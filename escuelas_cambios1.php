...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr valign="middle">
  	<td align=center>
           ...
           <form name="forma" method="post" action="escuelas_cambios2.php">
           <input type="hidden" name="id_escuela" value="<? echo $id_escuela1;?>">
